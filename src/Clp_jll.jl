...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Clp_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("06985876-5285-5a41-9fcb-8948a742cc53"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Clp", artifacts_toml) for e in artifacts["Clp"]]
...
if best_platform === nothing
    @debug("Unable to load Clp; unsupported platform $(triplet(platform_key_abi()))")
else
