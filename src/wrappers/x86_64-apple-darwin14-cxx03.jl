...
const libClpSolver_splitpath = ["lib", "libClpSolver.1.14.3.dylib"]
...
const libClp_splitpath = ["lib", "libClp.1.14.3.dylib"]
...
const libOsiClp_splitpath = ["lib", "libOsiClp.1.14.3.dylib"]
