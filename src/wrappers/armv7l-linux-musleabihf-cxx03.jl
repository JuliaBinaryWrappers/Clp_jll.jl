# Autogenerated wrapper script for Clp_jll for armv7l-linux-musleabihf-cxx03
export libClpSolver, libOsiClp, libClp
...
const libClpSolver_splitpath = ["lib", "libClpSolver.so"]
...
const libClpSolver = "libClpSolver.so.1"


# Relative path to `libOsiClp`
const libOsiClp_splitpath = ["lib", "libOsiClp.so"]
...
# This must be `const` so that we can use it with `ccall()`
const libOsiClp = "libOsiClp.so.1"


# Relative path to `libClp`
const libClp_splitpath = ["lib", "libClp.so"]
...
function __init__()
    ...
    foreach(p -> append!(PATH_list, p), (CoinUtils_jll.PATH_list, Osi_jll.PATH_list, METIS_jll.PATH_list, ASL_jll.PATH_list, OpenBLAS32_jll.PATH_list, CompilerSupportLibraries_jll.PATH_list,))
    foreach(p -> append!(LIBPATH_list, p), (CoinUtils_jll.LIBPATH_list, Osi_jll.LIBPATH_list, METIS_jll.LIBPATH_list, ASL_jll.LIBPATH_list, OpenBLAS32_jll.LIBPATH_list, CompilerSupportLibraries_jll.LIBPATH_list,))
